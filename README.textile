...
I've made this branch to be stowable so I may put it into my stowed bindir

to install todo.sh into the directory ~/stowdir/bin/ run this command from top-level directory:

    stow -t ~/stowdir/bin/ todo-source
